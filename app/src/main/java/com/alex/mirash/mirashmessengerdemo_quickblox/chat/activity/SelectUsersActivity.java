...
import com.alex.mirash.mirashmessengerdemo_quickblox.chat.tool.CheckboxUsersAdapter;
    ...
    private void loadUsersFromQb() {
        ...
        QBUsers.getUsers(new QBPagedRequestBuilder()).performAsync(new QBEntityCallback<ArrayList<QBUser>>() {
            ...
            public void onError(QBResponseException e) {
                showSnackbarError(R.string.select_users_get_users_error, e,
